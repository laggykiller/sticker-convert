...
class AdvancedCompressionWindow(BaseWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frame_advcomp.grid_columnconfigure(5, weight=1)
        ...
        ToolTip(self.fps_min_entry, text=self.gui.help['comp']['fps'], bootstyle='default')
        ...
        ToolTip(self.fps_max_entry, text=self.gui.help['comp']['fps'], bootstyle='default')
        ...
        ToolTip(self.res_w_min_entry, text=self.gui.help['comp']['res'], bootstyle='default')
        ...
        ToolTip(self.res_w_max_entry, text=self.gui.help['comp']['res'], bootstyle='default')
        ...
        ToolTip(self.res_h_min_entry, text=self.gui.help['comp']['res'], bootstyle='default')
        ...
        ToolTip(self.res_h_max_entry, text=self.gui.help['comp']['res'], bootstyle='default')
        ...
        ToolTip(self.quality_min_entry, text=self.gui.help['comp']['quality'], bootstyle='default')
        ...
        ToolTip(self.quality_max_entry, text=self.gui.help['comp']['quality'], bootstyle='default')
        ...
        ToolTip(self.color_min_entry, text=self.gui.help['comp']['color'], bootstyle='default')
        ...
        ToolTip(self.color_max_entry, text=self.gui.help['comp']['color'], bootstyle='default')
        ...
        ToolTip(self.duration_min_entry, text=self.gui.help['comp']['duration'], bootstyle='default')
        ...
        ToolTip(self.duration_max_entry, text=self.gui.help['comp']['duration'], bootstyle='default')
        ...
        ToolTip(self.img_size_max_entry, text=self.gui.help['comp']['size'], bootstyle='default')
        ...
        ToolTip(self.vid_size_max_entry, text=self.gui.help['comp']['size'], bootstyle='default')
        ...
        ToolTip(self.img_format_entry, text=self.gui.help['comp']['format'], bootstyle='default')
        ...
        ToolTip(self.vid_format_entry, text=self.gui.help['comp']['format'], bootstyle='default')
        ...
        ToolTip(self.fake_vid_cbox, text=self.gui.help['comp']['fake_vid'], bootstyle='default')
        ...
        ToolTip(self.scale_filter_opt, text=self.gui.help['comp']['fps'], bootstyle='default')
        ...
        ToolTip(self.cache_dir_entry, text=self.gui.help['comp']['cache_dir'], bootstyle='default')
        ...
        ToolTip(self.default_emoji_dsp, text=self.gui.help['comp']['default_emoji'], bootstyle='default')

        self.fps_lbl.grid(column=0, row=2, sticky='w', padx=3, pady=3)
        self.fps_min_lbl.grid(column=1, row=2, sticky='w', padx=3, pady=3)
        self.fps_min_entry.grid(column=2, row=2, sticky='nes', padx=3, pady=3)
        self.fps_max_lbl.grid(column=3, row=2, sticky='w', padx=3, pady=3)
        self.fps_max_entry.grid(column=4, row=2, sticky='nes', padx=3, pady=3)
        self.fps_disable_cbox.grid(column=5, row=2, sticky='nes', padx=3, pady=3)

        self.res_w_lbl.grid(column=0, row=3, sticky='w', padx=3, pady=3)
        self.res_w_min_lbl.grid(column=1, row=3, sticky='w', padx=3, pady=3)
        self.res_w_min_entry.grid(column=2, row=3, sticky='nes', padx=3, pady=3)
        self.res_w_max_lbl.grid(column=3, row=3, sticky='w', padx=3, pady=3)
        self.res_w_max_entry.grid(column=4, row=3, sticky='nes', padx=3, pady=3)
        self.res_w_disable_cbox.grid(column=5, row=3, sticky='nes', padx=3, pady=3)

        self.res_h_lbl.grid(column=0, row=4, sticky='w', padx=3, pady=3)
        self.res_h_min_lbl.grid(column=1, row=4, sticky='w', padx=3, pady=3)
        self.res_h_min_entry.grid(column=2, row=4, sticky='nes', padx=3, pady=3)
        self.res_h_max_lbl.grid(column=3, row=4, sticky='w', padx=3, pady=3)
        self.res_h_max_entry.grid(column=4, row=4, sticky='nes', padx=3, pady=3)
        self.res_h_disable_cbox.grid(column=5, row=4, sticky='nes', padx=3, pady=3)

        self.quality_lbl.grid(column=0, row=5, sticky='w', padx=3, pady=3)
        self.quality_min_lbl.grid(column=1, row=5, sticky='w', padx=3, pady=3)
        self.quality_min_entry.grid(column=2, row=5, sticky='nes', padx=3, pady=3)
        self.quality_max_lbl.grid(column=3, row=5, sticky='w', padx=3, pady=3)
        self.quality_max_entry.grid(column=4, row=5, sticky='nes', padx=3, pady=3)
        self.quality_disable_cbox.grid(column=5, row=5, sticky='nes', padx=3, pady=3)

        self.color_lbl.grid(column=0, row=6, sticky='w', padx=3, pady=3)
        self.color_min_lbl.grid(column=1, row=6, sticky='w', padx=3, pady=3)
        self.color_min_entry.grid(column=2, row=6, sticky='nes', padx=3, pady=3)
        self.color_max_lbl.grid(column=3, row=6, sticky='w', padx=3, pady=3)
        self.color_max_entry.grid(column=4, row=6, sticky='nes', padx=3, pady=3)
        self.color_disable_cbox.grid(column=5, row=6, sticky='nes', padx=3, pady=3)

        self.duration_lbl.grid(column=0, row=7, sticky='w', padx=3, pady=3)
        self.duration_min_lbl.grid(column=1, row=7, sticky='w', padx=3, pady=3)
        self.duration_min_entry.grid(column=2, row=7, sticky='nes', padx=3, pady=3)
        self.duration_max_lbl.grid(column=3, row=7, sticky='w', padx=3, pady=3)
        self.duration_max_entry.grid(column=4, row=7, sticky='nes', padx=3, pady=3)
        self.duration_disable_cbox.grid(column=5, row=7, sticky='nes', padx=3, pady=3)

        self.size_lbl.grid(column=0, row=8, sticky='w', padx=3, pady=3)
        self.img_size_max_lbl.grid(column=1, row=8, sticky='w', padx=3, pady=3)
        self.img_size_max_entry.grid(column=2, row=8, sticky='nes', padx=3, pady=3)
        self.vid_size_max_lbl.grid(column=3, row=8, sticky='w', padx=3, pady=3)
        self.vid_size_max_entry.grid(column=4, row=8, sticky='nes', padx=3, pady=3)
        self.size_disable_cbox.grid(column=5, row=8, sticky='nes', padx=3, pady=3)

        self.format_lbl.grid(column=0, row=9, sticky='w', padx=3, pady=3)
        self.img_format_lbl.grid(column=1, row=9, sticky='w', padx=3, pady=3)
        self.img_format_entry.grid(column=2, row=9, sticky='nes', padx=3, pady=3)
        self.vid_format_lbl.grid(column=3, row=9, sticky='w', padx=3, pady=3)
        self.vid_format_entry.grid(column=4, row=9, sticky='nes', padx=3, pady=3)

        self.fake_vid_lbl.grid(column=0, row=10, sticky='w', padx=3, pady=3)
        self.fake_vid_cbox.grid(column=5, row=10, sticky='nes', padx=3, pady=3)

        self.scale_filter_lbl.grid(column=0, row=11, sticky='w', padx=3, pady=3)
        self.scale_filter_opt.grid(column=1, row=11, columnspan=4, sticky='nes', padx=3, pady=3)

        self.cache_dir_lbl.grid(column=0, row=12, sticky='w', padx=3, pady=3)
        self.cache_dir_entry.grid(column=1, row=12, columnspan=4, sticky='nes', padx=3, pady=3)

        self.default_emoji_lbl.grid(column=0, row=13, sticky='w', padx=3, pady=3)
        self.default_emoji_dsp.grid(column=5, row=13, sticky='nes', padx=3, pady=3)
