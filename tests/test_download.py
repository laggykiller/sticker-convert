...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_signal_static_webp(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="signal",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_signal_animated_apng(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="signal",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_telegram_static_webp(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="telegram",
...
def test_download_telegram_animated_webm(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="telegram",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
@pytest.mark.skipif(not TELEGRAM_TOKEN, reason="No credentials")
def test_download_telegram_emoji(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="telegram",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_line_static_png_below_775(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="line",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_line_static_png_no_region_lock(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="line",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_line_static_png_with_region_lock(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="line",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_line_animated_apng(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="line",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_line_animated_apng_sound(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="line",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_line_animated_apng_popup(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="line",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_line_animated_apng_popup_foreground(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="line",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_line_animated_apng_name_text(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="line",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_line_animated_apng_per_sticker_text_no_cookies(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="line",
...
def test_download_line_animated_apng_per_sticker_text_with_cookies(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="line",
        url="https://store.line.me/stickershop/product/12188389/ja",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_line_static_png_emoji(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="line",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_line_animated_apng_emoji(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="line",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_kakao_static_png(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="kakao",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_kakao_animated_gif_store_link_no_token(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="kakao",
...
def test_download_kakao_animated_gif_store_link_with_token(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="kakao",
        url="https://e.kakao.com/t/lovey-dovey-healing-bear",
...
@pytest.mark.skipif(not TEST_DOWNLOAD, reason="TEST_DOWNLOAD not set")
def test_download_kakao_animated_gif_share_link(tmp_path):
    _run_sticker_convert(
        tmp_path=tmp_path,
        source="kakao",
